                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0">Liste des départementss</h4>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="modifier-departement.php?id=<?php echo $donnees['id']; ?>"><button type="button" class="btn btn-primary">modifier</button></a>
                                                    <a href="controller/SuppDepartement.php?id=<?php echo $donnees['id']; ?>"><button type="button" class="btn btn-danger">Supprimer</button></a>
                                                </td>
                                            </tr>
                                                <?php } ?>
                                            </tbody>
