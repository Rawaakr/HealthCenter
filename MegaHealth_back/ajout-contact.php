                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="card-title" style=" color: gray;font-weight: bold; font-size: 30px">Ajouter contact</h4>
                                        <br>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <input class="form-control" name="prenom" type="text" placeholder="prenom" id="example-text-input">
                                            </div>
                                        </div>
