                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h1 class="card-title" style=" color: gray;font-weight: bold; font-size: 30px">Ajouter médecin</h1>
                                        <br>
                                        <form action=" controller/ajoutMedecin.php" method="post">
                                        <div class="row mb-3">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <input class="form-control" name="login" type="text" placeholder="Login" id="example-text-input">
                                            </div>
                                        </div>
