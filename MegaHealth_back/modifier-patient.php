                            ...
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <h1 class="card-title" style=" color: gray;font-weight: bold; font-size: 30px">Modifier administrateur</h1>
                                        <br>
                                        <form action="controller/modifPatient.php?id=<?php echo $donnees['id'];?>" method="post">
                                        <div class="row mb-3">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <input class="form-control" type="text" name="departement" value="<?php echo $donnees['departement']?>" id="example-text-input">
                                            </div>
                                        </div>
