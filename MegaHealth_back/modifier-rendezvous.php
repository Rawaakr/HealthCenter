...
/*echo $id;
exit;*/
$req = $bdd->query(" SELECT * FROM rendezvous WHERE id = $id ");
$donnees = $req->fetch();
?>
<!doctype html>
<html lang="en">
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="card-title" style=" color: gray;font-weight: bold; font-size: 30px">Modifier rendez-vous</h4>
                                        <br>
                                        <form action="controller/modifRendezvous.php?id=<?php echo $donnees['id'];?>" method="post">
                                        <div class="row mb-3">
                                        ...
                                        <div class="row mb-3">
                                            <label for="example-text-input" class="col-sm-2 col-form-label">Nom Médecin</label>
                                            <div class="col-sm-10">
                                                <input class="form-control" type="text" name="nomMedecin" value="<?php echo $donnees['nomMedecin']?>" id="example-text-input">
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            <label for="example-text-input" class="col-sm-2 col-form-label">Date</label>
                                            <div class="col-sm-10">
                                                <input class="form-control" type="date" name="Date" value="<?php echo $donnees['Date']?>" id="example-text-input">
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            <label for="example-text-input" class="col-sm-2 col-form-label">Heure</label>
                                            <div class="col-sm-10">
                                                <input class="form-control" type="time" name="Heure" value="<?php echo $donnees['Heure']?>" id="example-text-input">
                                            </div>
                                        </div>
                                        <div>
