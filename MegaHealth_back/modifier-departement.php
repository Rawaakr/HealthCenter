...
/*echo $id;
exit;*/
$req = $bdd->query(" SELECT * FROM departements WHERE id = $id ");
$donnees = $req->fetch();
?>
<!doctype html>
<html lang="en">
...
<head>
        ...
        <meta charset="utf-8" />
        <title>modifier departements</title>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h1 class="card-title" style=" color: gray;font-weight: bold; font-size: 30px">Modifier département</h1>
                                        <br>
                                        <form action="controller/modifDepartement.php?id=<?php echo $donnees['id'];?>" method="post">
                                        <div class="row mb-3">
