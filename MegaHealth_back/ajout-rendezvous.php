                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="card-title" style=" color: gray;font-weight: bold; font-size: 30px">Ajouter rendez-vous</h4>
                                        <br>
                                        <form action="controller/ajoutRendezvous.php" method="post">
                                        <div class="row mb-3">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <input class="form-control" name="nomMedecin" type="text" placeholder="nom" id="example-text-input">
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            <label for="example-text-input" class="col-sm-2 col-form-label">Date</label>
                                            <div class="col-sm-10">
                                                <input class="form-control" name="date" type="date" placeholder="jj/mm/yy" id="example-text-input">
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            <label for="example-text-input" class="col-sm-2 col-form-label">Heure</label>
                                            <div class="col-sm-10">
                                                <input class="form-control" name="heure" type="time" placeholder="hh:mm:ss" id="example-text-input">
                                            </div>
                                        </div>
                                        <div>
